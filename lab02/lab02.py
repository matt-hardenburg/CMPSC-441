...
def best_hand(hand):
    ...
    # Your code here
    all_combos = itertools.combinations(hand, 5)    # extract all possible five card combinations
    best_combo, best_rank = None, None

    for combo in all_combos:
        rank = hand_rank(combo)
        if best_rank is None or rank > best_rank:   # find best combo by storing largest rank
            best_combo = combo
            best_rank = rank
